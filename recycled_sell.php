...
<section class="contact">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <h3>Sell your Old Art Products here</h3>
      ...
      <input type="text" name="recycle_name" min="0" max="9999999999" placeholder="enter name of product to recycle" required onkeypress="if(this.value.length == 10) return false;" class="box">
      ...
      <input type="number" name="price" min="0" max="9999999999" placeholder="enter price of recycle product" required onkeypress="if(this.value.length == 10) return false;" class="box">     
...
if(isset($_POST['send']))
{
   ...
   $email = $_POST['email'];
   $number = $_POST['number'];
   $recycle_name = $_POST['recycle_name'];
   ...
   $query = "INSERT INTO `recycle`(`name`, `email`, `number`, `recycle_name`, `image1`, `image2`, `price`, `discription`, `message`) VALUES ('$name', '$email', ' $number', '$recycle_name', '$file', '$file', '$price', '$discription', '$message')";
   $query_run = mysqli_query($connection,$query);

   if($query_run)
   {
      echo '<script type="text/javascript"> alert("recycled product details Uploaded") </script>';
   }
   else
   {
      echo '<script type="text/javascript"> alert("recycled product details Not Uploaded") </script>';
   }
}
